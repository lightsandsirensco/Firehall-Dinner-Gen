  ...
  <DialogPortal>
    ...
    >
      ...
      <div className="absolute right-4 top-4">
        <DialogPrimitive.Close className="rounded-full h-10 w-10 grid place-items-center hover-elevate active-elevate-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
          <X className="h-4 w-4" />
