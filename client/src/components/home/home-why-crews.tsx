...
const VALUES = [
  { title: "Large crews", body: "Portions scale without spreadsheet math.", icon: Users },
  { title: "Honest timing", body: "Steps that respect a real hall clock.", icon: AlarmClock },
  ...
  {
    title: "Probie-Proof Instructions",
    body: "Step-by-step directions anyone can follow — no guessing, no kitchen disasters.",
    icon: ChefHat,
  },
  {
    title: "Automatic Shopping Lists",
    body: "Get a complete ingredient list for the entire crew, sized automatically to your hall.",
    icon: ShoppingCart,
  },
] as const;
    ...
    >
      <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] gap-12 lg:gap-16 items-start">
        <div className="lg:sticky lg:top-24">
          ...
          <Button
            asChild
            className="mt-8 hidden sm:inline-flex font-heading uppercase tracking-[0.1em] text-xs"
          >
      ...
      <div className="mt-10 sm:hidden">
        <Button asChild className="w-full h-12 font-heading uppercase tracking-[0.1em] text-xs">
          <Link href="/generator">{CTA.findDinner}</Link>
        </Button>
      </div>
    </section>
