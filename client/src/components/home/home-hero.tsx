  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-page w-full pb-10 sm:pb-14 pt-28 sm:pt-32">
        ...
        <h1
          className="mt-4 font-heading text-[2.75rem] sm:text-6xl md:text-[4.25rem] leading-[0.92] tracking-tight text-foreground max-w-[12ch] sm:max-w-none drop-shadow-[0_2px_24px_rgba(0,0,0,0.85)]"
        ...
        <p
          className={cn(
            "mt-4 font-heading uppercase",
            "text-primary/95 drop-shadow-[0_1px_16px_rgba(0,0,0,0.85)]",
            "text-sm sm:text-base tracking-[0.32em] sm:tracking-[0.38em]",
          )}
