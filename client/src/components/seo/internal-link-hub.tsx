...
const HUB_LINKS: InternalLink[] = [
  ...
  { href: "/firehouse-meals", label: "Firehouse meals", description: "Classic station dinners" },
  { href: "/firefighter-dinner-ideas", label: "Firefighter dinner ideas", description: "When the whiteboard is blank" },
  { href: "/crew-meals", label: "Crew meals", description: "Portions for 2–20 firefighters" },
  ...
  { href: "/fire-hall-grocery-list", label: "Crew Shopping List", description: "Fire hall grocery lists" },
  { href: "/crew-grocery-budget", label: "Hall Grocery Budget", description: "Crew spend without blame" },
