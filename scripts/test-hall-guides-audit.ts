...
// 57, not 58 — /guides/firefighter-bbq-recipes was consolidated into a
// 301 redirect to /firefighter-bbq-recipes (see seo-articles-data.ts).
...
assert.equal(summary.p0 + summary.p1 + summary.p2, 57);
