...
async function main(): Promise<void> {
  ...
  const summary = summarizeEditorialQaReports(reports);
  ...
  console.log(`[editorial-qa] publish-safe: ${summary.publishSafe} · needs review: ${summary.blocked}`);
  console.log(`[editorial-qa] critical=${summary.totals.critical} warning=${summary.totals.warning} info=${summary.totals.info}`);
