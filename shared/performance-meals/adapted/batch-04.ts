...
export const batch04: PerformanceAdaptedRecipe[] = [
  ...
  perfRecipe({
    manifest: manifestEntry({
      slug: "coconut-curry-chicken-pot",
      title: "Coconut Curry Chicken Pot",
      subtitle: "One-pot chicken with coconut milk, sweet potato, and spinach",
      protein: "chicken",
      cuisine: "Thai-inspired",
      mealFormat: "one_pot",
      hook: "Aromatic curry that holds hot on the back burner all evening",
      prep: 20,
      cook: 35,
      difficulty: "medium",
      sourceId: "ba-02",
    ...
    description:
      "Chicken thighs simmer in coconut milk with red curry paste, sweet potato, and spinach until the broth is fragrant and slightly thick.",
    whyCrewsLikeIt:
      "Bold flavor without deep frying. One pot feeds eight and improves as it rests.",
    mealPrepNotes:
      "Dice sweet potato uniform for even cooking. Open coconut milk cans before starting.",
    stationWorkflow: [
      "Brown thighs first for depth—poaching alone makes flat flavor.",
      "Simmer gently after adding coconut milk—boiling splits the fat.",
      "Stir spinach in off heat so it stays bright green at service.",
    ],
    ingredients: [
      { name: "boneless chicken thighs", quantity: 4, unit: "lb", notes: "cubed" },
      { name: "sweet potato", quantity: 2, unit: "lb", notes: "peeled, ½-inch dice" },
      { name: "coconut milk", quantity: 2, unit: "cans", notes: "13.5 oz full-fat" },
      ...
      { name: "garlic cloves", quantity: 5, unit: "cloves", notes: "minced" },
      { name: "fresh ginger", quantity: 2, unit: "tbsp", notes: "grated" },
      { name: "fresh spinach", quantity: 6, unit: "cups", notes: "packed" },
    ...
    stepLines: [
      {
        title: "Brown chicken",
        instruction:
          "Sear cubed thighs in oil over medium-high 8–10 minutes until golden on edges. Work in batches so meat browns, not steams in its own liquid.",
        minutes: 10,
        heatLevel: "medium-high",
      },
      {
        title: "Sweat aromatics and curry",
        instruction:
          "Add onion, cook 4 minutes. Stir in garlic, ginger, and curry paste. Cook 2 minutes until paste smells fragrant and oil turns reddish.",
        minutes: 6,
      },
      {
        title: "Simmer with coconut milk",
        instruction:
          "Add sweet potato, coconut milk, broth, and fish sauce. Simmer 20–25 minutes until potato pierces easily and chicken is tender throughout.",
        minutes: 25,
      ...
      },
      {
        title: "Wilt spinach",
        instruction:
          "Remove from heat, stir in spinach until wilted and deep green. Curry should look creamy with visible orange oil droplets on surface.",
        minutes: 3,
      },
      {
        title: "Finish with lime",
        instruction:
          "Stir in lime juice. Taste and adjust salt. Sauce should balance rich, spicy, and bright—not flat or overly sweet.",
        minutes: 2,
      },
    ],
    nutrition: { calories: 445, protein: 36, carbs: 28, fats: 24, fiber: 5 },
    proTips: [
      "Offer jasmine rice for soaking up curry—crew will want it.",
      "Yellow curry paste swap works for milder heat.",
      "Leftover curry thickens—add broth when reheating.",
    ],
    tonightSpread: ["Jasmine rice.", "Sliced cucumber with rice vinegar."],
    leftovers: [
      "Curry over rice noodles next day.",
      "Freeze portions without spinach; add fresh greens when reheating.",
    ],
    equipment: ["8-quart Dutch oven", "Wooden spoon"],
    spiceLevel: "medium",
    cleanupDifficulty: "easy",
  }),
