...
const CLASSICS = [
  ...
  goldenEntry({ slug: "jerk-chicken", title: "Jerk Chicken", cat: "firehall_classics", protein: "chicken", cuisine: "caribbean", format: "grill", pools: ["trending", "chicken"], hook: "Island heat that still feeds eight", classic: "jerk-chicken", inspiration: "Firehall Classics" }),
...
const COMFORT = [
  goldenEntry({ slug: "mac-and-cheese-bake", title: "Baked Mac and Cheese", cat: "comfort_food", protein: "vegetarian", cuisine: "american", format: "pasta", pools: ["comfort", "pasta"], hook: "Creamy, bubbling, hall-approved mac", search: "baked mac and cheese dinner", inspiration: "NYT Cooking" }),
  goldenEntry({ slug: "shepherds-pie", title: "Shepherd's Pie", cat: "comfort_food", protein: "beef", cuisine: "british", format: "plated_main", pools: ["comfort", "hearty"], hook: "Rich filling, golden potato cap", search: "shepherds pie ground beef", inspiration: "Bon Appétit" }),
