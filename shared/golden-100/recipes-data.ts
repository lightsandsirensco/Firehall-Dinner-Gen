...
const BIG_CREW = [
  ...
  goldenEntry({ slug: "big-chili", title: "Hall-Sized Beef and Bean Chili", cat: "big_crew_feeders", protein: "beef", cuisine: "american", format: "soup_chili", pools: ["hearty", "beef"], hook: "Double pot, triple appetite", search: "large batch beef chili", inspiration: "Serious Eats", sourceUrl: "https://www.seriouseats.com/the-best-chili-recipe", rec: { feedsHardScore: 10 } }),
