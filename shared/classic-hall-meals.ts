...
export const CLASSIC_HALL_MEALS: ClassicHallMealMeta[] = [
  ...
  },
  {
    ...
    heroImagePath: "/images/golden-100/bbq-chicken-bowls.jpg",
    imageAlt:
      "BBQ glazed chicken thigh strips over steamed rice with corn and coleslaw in crew-sized bowls on a firehall prep line",
    imageKeywords: ["bbq", "barbecue", "chicken", "bowl", "rice", "corn", "slaw", "glazed", "thigh"],
    cuisine: "BBQ",
    mealFormat: "bowl",
    protein: "Chicken",
