...
export const CLASSIC_HALL_MEALS: ClassicHallMealMeta[] = [
  ...
  },
  {
    ...
    displayTitle: "Chimichurri Steak Tacos — Street-Style",
    description:
  ...
  },
  {
    ...
    displayTitle: "Carolina Pulled Pork — Hall Line Special",
    description: "Vinegar-mopped Carolina pull with cold slaw on soft buns.",
    tagline: "Vinegar pull, slaw, soft buns",
    emoji: "🐖",
  ...
  },
  {
    ...
    title: "Philly-Style Cheesesteaks",
    shortLabel: "Cheesesteaks",
    displayTitle: "Philly-Style Cheesesteaks — Hall Griddle Night",
    description:
      "Chopped ribeye, sweet onions, and provolone melted into the meat on soft toasted rolls.",
    tagline: "Chopped ribeye, provolone melted in",
    emoji: "🥩",
    spoonacularRecipeId: 663235,
    spoonacularTitle: "The Best Steak Sandwich",
    imageAlt: "Chopped ribeye cheesesteaks with melted provolone and onions on soft toasted rolls",
    imageKeywords: ["cheesesteak", "steak", "ribeye", "sandwich", "beef", "provolone", "cheese", "onion"],
    cuisine: "American",
    mealFormat: "sandwich",
    protein: "Beef",
    ...
    searchQuery: "philly cheesesteak",
