...
const CURATED_HALL_PACKAGES_RAW: CuratedPackageInput[] = [
  ...
  },
  {
    ...
    crewLine:
      "One heavy pot of competition-style chili — toasted ancho puree, hard-browned chuck, masa finish — with cheese-pull garlic bread and a topping bar.",
    prepMin: 25,
    cookMin: 80,
    macros: { calories: 1250, protein_g: 88, carbs_g: 78, fat_g: 65 },
    plate: {
      display_title: "Firehouse Smoked Beef Chili with Cheesy Garlic Bread",
      main: [{ name: "Ancho-chipotle beef chili", amount: "1 big pot (8+ hall portions)", role: "main" }],
      sides: [
        { name: "Cheddar-mozzarella garlic bread", amount: "3 split loaves", role: "starch" },
    ...
    ingredients: [
      { name: "Ground beef chuck (80/20)", qty: 4, unit: "lb", category: "Proteins" },
      { name: "Dried ancho chiles", qty: 5, unit: "whole", category: "Pantry" },
      { name: "Chipotles in adobo (minced, with sauce)", qty: 3, unit: "tbsp", category: "Pantry" },
      { name: "Yellow onions", qty: 3, unit: "large", category: "Produce" },
      { name: "Garlic cloves", qty: 10, unit: "", category: "Produce" },
      { name: "Chili powder", qty: 2, unit: "tbsp", category: "Pantry" },
      { name: "Ground cumin", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Smoked paprika", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Dried oregano", qty: 2, unit: "tsp", category: "Pantry" },
      { name: "Unsweetened cocoa powder", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Tomato paste", qty: 3, unit: "tbsp", category: "Pantry" },
      { name: "Crushed fire-roasted tomatoes", qty: 1, unit: "can (28 oz)", category: "Pantry" },
      { name: "Dark lager or brewed coffee", qty: 1.5, unit: "cups", category: "Pantry" },
      { name: "Beef broth", qty: 3, unit: "cups", category: "Pantry" },
      { name: "Kidney beans", qty: 2, unit: "cans (15 oz)", category: "Pantry" },
      { name: "Pinto beans", qty: 1, unit: "cans (15 oz)", category: "Pantry" },
      { name: "Soy sauce", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Worcestershire sauce", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Masa harina", qty: 3, unit: "tbsp", category: "Pantry" },
      { name: "Apple cider vinegar", qty: 1.5, unit: "tbsp", category: "Pantry" },
      { name: "Brown sugar", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Hot sauce", qty: 1, unit: "tbsp", category: "Pantry" },
      { name: "Italian bread or baguettes", qty: 3, unit: "loaves", category: "Bakery" },
      { name: "Unsalted butter (softened)", qty: 0.75, unit: "cup", category: "Dairy" },
      { name: "Shredded sharp cheddar", qty: 12, unit: "oz", category: "Dairy" },
      { name: "Shredded mozzarella", qty: 12, unit: "oz", category: "Dairy" },
      { name: "Fresh jalapeño peppers", qty: 4, unit: "", category: "Produce" },
      { name: "Fresh cilantro", qty: 1, unit: "bunch", category: "Produce" },
      { name: "Sour cream", qty: 2, unit: "cups", category: "Dairy" },
    ],
    steps: [
      {
        title: "Toast the anchos & blend the chile base (medium, 12 min)",
        heat: "medium",
        minutes: 12,
        instructions:
          "Tear the dried ancho chiles open; discard stems and seeds. Toast them in the dry stock pot over medium heat, pressing flat with a spatula, 30–45 seconds per side until they smell like raisins and toast — do not let them scorch or they turn bitter. Add 2 cups of broth and simmer 5 minutes until the chiles are fully pliable — softening first is what keeps the puree silky instead of gritty. Blend with the chipotles in adobo until completely smooth, about 1 minute. This puree is the backbone of the pot — fresh-toasted chiles carry the deep fruit and smoky depth that jarred chili powder lost months ago on the shelf.",
      },
      {
        ...
        minutes: 15,
        instructions:
          "Dice onions into ¼-inch pieces and mince garlic. Drain and rinse the kidney and pinto beans. Open the crushed tomatoes. Measure chili powder, cumin, smoked paprika, oregano, and cocoa powder into one small bowl — they go into hot fat together and will burn if you're hunting jars. Line two sheet pans for garlic bread. Chili moves fast once heat starts; a set station is the difference between layering flavor and scorching it.",
      },
      {
        title: "Brown the beef hard, in batches (medium-high, 15 min)",
        heat: "high",
        minutes: 15,
        instructions:
          "Heat 2 tbsp oil in the pot over medium-high until shimmering. Add the ground chuck in two or three batches — press each batch flat and leave it alone 3–4 minutes so a deep brown crust forms before you break it into crumbles. Browning is where the roasty backbone comes from; a crowded pot steams the meat gray and you never get that flavor back. Cook each batch until no pink remains (160°F). Transfer to a bowl, pour off all but 2 tbsp fat, and keep every browned bit stuck to the pot — that fond is concentrated beef flavor you'll dissolve back in.",
      },
      {
        title: "Soften onions & bloom the spices (medium, 10 min)",
        heat: "medium",
        minutes: 10,
        instructions:
          "Drop the heat to medium. Cook the onions with a pinch of salt 6–8 minutes, scraping up fond as they release moisture, until soft with golden edges. Stir in the garlic for 30 seconds. Add the spice bowl — chili powder, cumin, smoked paprika, oregano, cocoa — straight into the fat and stir 45–60 seconds until it smells toasty. Spices are fat-soluble; blooming them in hot fat pulls out flavor that water never touches. Stir in the tomato paste and brown sugar; cook 1 minute until the paste darkens to brick red.",
      },
      {
        title: "Deglaze & build the pot (medium-high, 5 min)",
        heat: "medium",
        minutes: 5,
        instructions:
          "Pour in the beer or coffee and scrape the bottom until it's clean — that roasty, faintly bitter note backs up the chiles the way it does in competition pots. Simmer 2 minutes to cook off the raw alcohol edge. Stir in the ancho-chipotle puree, crushed tomatoes, the rest of the broth, soy sauce, and Worcestershire, then return the browned meat and its juices.",
      },
      {
        title: "Simmer low, then add the beans (low, 45 min)",
        heat: "low",
        minutes: 45,
        instructions:
          "Bring to a gentle bubble, then drop to a lazy simmer — small bubbles breaking the surface, never a boil, which turns the meat grainy and scorches the base. Cook uncovered 25 minutes, stirring every 10. Stir in the kidney and pinto beans and simmer 20 more — added late, they soak up seasoning without blowing out to mush. The pot is ready when a spoon dragged across it leaves a trail that closes slowly.",
      },
      {
        title: "Thicken with masa & finish with acid (low, 5 min)",
        heat: "low",
        minutes: 5,
        instructions:
          "Whisk the masa harina with ½ cup warm water into a smooth slurry and stir it in; simmer 3–4 minutes until the chili turns glossy and thick. Masa doesn't just thicken — it adds the sweet corn depth that separates competition chili from flour-thickened stew. Kill the heat. Stir in the cider vinegar and hot sauce, then taste for salt. A long simmer dulls brightness; finishing acid snaps every layer back into focus.",
      },
      {
        title: "Bake the cheesy garlic bread (425°F, 12 min)",
        heat: "high",
        minutes: 12,
        instructions:
          "While the pot simmers, mash the softened butter with 3 minced garlic cloves and a pinch of salt. Halve the loaves lengthwise and spread butter edge to edge — bare edges burn before the middle melts. Pile on the cheddar and mozzarella. Bake at 425°F for 10–12 minutes, rotating pans halfway, until the cheese bubbles with golden spots and the edges crisp.",
      },
      {
        title: "Set the topping bar (no heat, 5 min)",
        heat: "none",
        minutes: 5,
        instructions:
          "Portion the sour cream, remaining shredded cheese, sliced jalapeños, chopped cilantro, and a bowl of diced raw onion; keep cold toppings on ice. The bar lets every firefighter set their own heat — the pot stays medium so nobody's bowl is a casualty.",
      },
      {
        title: "Ladle & serve the line (low, 5 min)",
        heat: "low",
        minutes: 5,
        instructions:
          "Ladle deep bowls and slice the garlic bread into thick sticks on a separate tray so steam doesn't sog the crust. Call the crew while the cheese is still molten — the first bowl out of a fresh pot is the best one.",
      },
      {
        ...
        minutes: 10,
        instructions:
          "Cool chili in shallow containers within two hours; it keeps 4 days refrigerated and tastes better on day two once the chile base finishes marrying. Reheat on the stove to 165°F with a splash of broth — masa thickens overnight. Freeze up to 3 months. Rebake day-old garlic bread 5 minutes at 400°F; never store bread sealed with hot chili.",
      },
    ],
    whyItFits:
      "Built like the award-winners: toasted whole chiles instead of dusty powder, hard-browned beef, cocoa and coffee in the base, and a finishing hit of acid — the pot crews argue over who takes home.",
    cleanupTip:
    ...
    proTips: [
      ...
      "Scale beef + tomatoes 1.25× for 10+ crew; keep the chile base the same first, adjust heat at the bar.",
    ],
  },
  {
    slug: "chicken-caesar",
