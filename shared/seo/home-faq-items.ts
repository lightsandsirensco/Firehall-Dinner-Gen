...
/** Firefighter-focused FAQ — home, /faq, and FAQPage schema (client + server injection). */
export const HOME_FAQ_ITEMS: FaqItem[] = [
  {
    question: "What does Firehall Meals do for me as a firefighter?",
    answer:
      "Pick shift dinners in seconds, save meals you love, get crew-sized ingredients and shopping lists, and cook with steps written for station kitchens. Sign in to sync across devices. Hall Operations (shared votes and grocery planning) is currently in private beta — join the waitlist to get early access.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. You can pick meals, browse recipes, spin the wheel, and save favorites without linking a hall. Shared dinner votes, grocery lists, and crew meal history are part of Hall Operations, which is in private beta — join the waitlist to be notified when it opens to your station.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "It is a meal app for firefighters — crew portions, shift timing, and cook mode built in. Use it solo today, with shared hall planning rolling out through private beta. Built by firefighters. Tested on real shifts.",
  },
];
